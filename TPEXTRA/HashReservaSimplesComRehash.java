...
class TabelaHashRehash {
    ...
    public int pesquisar(String nome) {
        ...
        if (tabela[h1] != null && tabela[h1].equals(nome)) {
            return h1;
        }

        int h2 = hash2(nome);

        if (tabela[h2] != null && tabela[h2].equals(nome)) {
            return h2;
        }
    ...
    public int posTeorica(String nome) {
        return hash1(nome);
    }
}


public class HashReservaSimplesComRehash {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TabelaHashRehash hash = new TabelaHashRehash();
        ...
        PrintWriter pw = new PrintWriter("800772_hashRehash.txt");
        ...
        while (!nome.equals("FIM")) {
            ...
            if (pos == -1) {
                int teorica = hash.posTeorica(nome);
                System.out.println(nome + ":  (Posicao: " + teorica + ") NAO");
                pw.println(nome + ":  (Posicao: " + teorica + ") NAO");
            } else {
