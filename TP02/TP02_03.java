...
public class TP02_03  {
    ...
    public static boolean pesquisaSequencial(Show[] shows, String titulo) {
        for (Show show : shows) {
    ...
    public static void main(String[] args) {
        ...
        String[] linhas = lerCSV("/tmp/data.csv");
        ...
        // Segunda parte - leitura de títulos para pesquisa
        ...
        // Pesquisa sequencial pelos títulos
        for (String titulo : titulos) {
            boolean encontrado = pesquisaSequencial(shows, titulo);
